  ...
  <div class="page-title">
    <div class="title_right">
      <div class="col-md-12 col-sm-12 col-xs-12 form-group pull-right top_search">
        ...
        <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newSubMenuModal">Add New Area</a>
        ...
        <?= $this->session->flashdata('message'); ?>
            <div class="col-xl-3 mt-3">
                <form action="<?= base_url('master/masterprov'); ?>" method="post">
...
<div class="modal fade" id="newSubMenuModal" tabindex="-1" role="dialog" aria-labelledby="newSubMenuModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('master/tambahprov'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control" id="data" name="data" placeholder="Nama Area">
                    </div>
                    <div class="form-group">
