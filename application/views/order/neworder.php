                    ...
                    <div class="card-body" width="auto">
                                            ...
                                            <table class="table table-bordered table-m w-auto large">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><input type="number" name="nik[]" id="nik1" alt="1" required="required"></td>
                                                        <td>
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right animated--grow-in" aria-labelledby="navbarDropdown" id="dropdown">
                                    <?php foreach ($kot as $kt) : ?>
                                      ...
                                      <?php endforeach; ?>
                                                        ...
                                                        <td>
                                                            <input name="tanggal_lahir[]" id="tanggal_lahir1" width="276" alt="1" required="required" placeholder="dd-mm-yyyy">
                                                        </td>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                ...
                                <button type="button" value="submit" id="cek" data-toggle="modal" data-target="#confirm-submit" class="btn btn-success">Simpan</button>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><b>yakin akan submit data?</b></h4>
            </div>
            ...
            <div class="modal-body">
                <table style="width:100%">
                    <tr>
                        ...
                        <td height top="40" style="width:70%" id="no_kontrak_modal"></td>
                    </tr>
                    <tr>
                        <td style="width:30%">No KK</td>
                        <td height top="40" style="width:70%" id="kk_modal"></td>
                    </tr>
                    <tr>
                        <td style="width:30%">Alamat</td>
                        <td height top="40" style="width:70%" id="alamat_modal"></td>
                    </tr>
                    <tr>
                        <td style="width:30%">kepala keluarga</td>
                        <td height top="40" style="width:70%" id="kepalakeluarga_modal"></td>
                    </tr>
                    <tr>
                        <td style="width:30%">Kode Pos</td>
                        <td height top="40" style="width:70%" id="kodepos_modal"></td>
                    </tr>
                   
                    <tr>
                        <td style="width:30%">Status Input</td>
                        <td height top="40" style="width:70%" id="status_modal"></td>
                    </tr>
                    </table>
                <p class="debug-url"></p>
            </div>
            <div class="modal-footer">
                <button type="submit" id="submit-modal" class="btn btn-primary">Save changes</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                    <a id="submit-modal" class="btn btn-success success">Submit</a>
                </div>
            </div>
        </div>
    </div>
    ...
    $(document).ready(function() {
        ...
        $(".tambah-form").on('click', function() {
            row =
                ...
                '<td><input type="number" name="nik[]" id="nik' + i + '" alt="' + i + '" required="required">' +
                ...
                '<td><input name="tanggal_lahir[]" id="tanggal_lahir' + i + '" alt="' + i + '" required="required" placeholder="dd-mm-yyyy">' +
        ...
        $(document).on("click", "#cek", function() {
            ...
            var status = $("#remark_kk").val();
            var kepalakeluarga = $("#kepalakeluarga").val();
            var alamat = $("#alamat").val();
            var valid= /[^a-zA-Z]+$/;
            // var e = document.forms["#demo"];
            var count= document.getElementsByName("nik[]").length;
            // var count = document.forms["#demo"].elements["nik[]"].length;
            ...
            for ( i = 0; i <= count; i++) {
                ...
                if (!nik.match(valid)){
                alert("no KTP wajib diisi dan format Number");
                return false;
                
            
                } else if (!no_kontrak.match(valid) | no_kontrak == "") {
                alert("no Kontrak wajib diisi dan format Number");
                return false;
                } else if (!no_kk.match(valid) | no_kk == "") {
                alert("no KK wajib diisi dan format Number");
                return false;
                } else if (!kodepos.match(valid) | kodepos == "") {
                alert("kodepos wajib diisi dan format Number");
                return false;
                
                } else {
                    $("#confirm-save").modal("show");
                    $('#no_kontrak_modal').text(no_kontrak);
                    $('#kk_modal').text(no_kk);
                    $('#alamat_modal').text(alamat);
                    $('#kepalakeluarga_modal').text(kepalakeluarga);
                    $('#kodepos_modal').text(kodepos);
                    $('#status_modal').text(status);
                   // $('#nik_modal').text(nik);
                }
...
//         var no_kontrak = $("#no_kontrak").val();
//         var nik = [];
//         for (var i = 1 i <  $('#jumlahkolom').val(); ++i) {
//         nik[i] = $("#nik+i").val();
...
//         } else if (nik[i].match(regex)) {
//             alert("ktp wajib angka");
//             return false;
//         } else {
//             $("#confirm-save").modal("show");
//             $('#no_kontrak_modal').text(no_kontrak);
//             $('#nik_modal').text("nik"+i);
